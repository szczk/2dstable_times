...
Datafile * Datafile::open(string filename)
{
    return Datafile::open(filename.c_str());
}
...
Datafile * Datafile::create(string filename)
{
    return Datafile::create(filename.c_str());
}
